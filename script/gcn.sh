...
## v nodes
python ogb_models/proteins/main_gnn.py --log_steps 1 --num_layers 3 --hidden_channels 256 --dropout 0.5 --lr 0.01 --epochs 1000 --eval_steps 9 --runs 5 --device 0 --num_parts 5
